...
class TestArtistService:
    ...
    def test_get_all_items_count(self, query_mock):
        query_mock.return_value.count.return_value = 1
    ...
    @mock.patch('flask_sqlalchemy._QueryProperty.__get__')
    def test_get_filtered_items_by_page(self, query_mock, last_name_mock, first_name_mock):
        test_artists = TestArtistService.test_artists
        query_mock.return_value.paginate.return_value.items = test_artists
        search_term = 'search'
